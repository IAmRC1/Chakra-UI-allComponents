...
import { Flex, Spacer, Center, Text, Square, Box, Grid, HStack, Heading, Button, } from "@chakra-ui/react"

export default function CustomFlex() {
  return (
    <div>
      <Flex color="white" align="center">
        <Center w="100px" h="200px" bg="green.500">
          <Text>Box 1</Text>
        </Center>
        <Square bg="blue.500" size="150px">
          <Text>Box 2</Text>
        </Square>
        <Box flex="1" h="200px" bg="tomato">
          <Text>Box 3</Text>
        </Box>
      </Flex>
      <Flex>
        <Box p="4" bg="red.400" color="white.500">
          Box 1
        </Box>
        <Spacer />
        <Box p="4" bg="green.400" color="orange.300">
          Box 2
        </Box>
      </Flex>
      <Box>
